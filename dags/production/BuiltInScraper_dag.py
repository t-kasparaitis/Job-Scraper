...
from scrapers import BuiltInScraper
import pendulum
...
dag = DAG(
    ...
    description='This DAG scrapes BuiltIn based on search_terms.json and writes each result set to a CSV file.',
    schedule_interval=timedelta(hours=4),
    tags=['scraper', 'BuiltIn']
)
...
builtin_scraper_task = PythonOperator(
    task_id='run_builtin_scraper',
