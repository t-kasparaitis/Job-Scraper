...
dag = DAG(
    ...
    description='This DAG scrapes LinkedIn based on search_terms.json and writes each result set to a CSV file.',
    schedule_interval=timedelta(hours=4),
    tags=['scraper', 'LinkedIn']
)
...
linkedin_scraper_task = PythonOperator(
